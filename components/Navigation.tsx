          ...
          <div className="md:hidden border-t border-gray-200 bg-[#FCFCFC]">
            <Container>
              <div className="py-2 flex flex-col">
                <Link
                  href="/blog"
                  className="px-2 py-3 text-gray-800 hover:bg-gray-100 rounded flex items-center"
                ...
                <a
                  ...
                  className="px-2 py-3 text-[#712C94] hover:bg-gray-100 rounded font-semibold"
                  onClick={() => setMobileOpen(false)}
                >
                  Log in
                </a>
                <a
                  href="https://student.gdacademy.et/auth/signin"
                  className="mt-2 mb-3 inline-flex items-center justify-center rounded-md px-4 py-2 bg-[#3C4852] text-white font-semibold"
                  onClick={() => setMobileOpen(false)}
                >
                  Join for free
                </a>
